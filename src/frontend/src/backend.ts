...
export class Backend implements backendInterface {
    ...
    async acceptMicRequest(arg0: bigint, arg1: Principal): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.acceptMicRequest(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async addBalance(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
    ...
    async getAudioClips(arg0: bigint): Promise<Array<AudioClip>> {
        if (this.processError) {
            try {
                const result = await this.actor.getAudioClips(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getCurrentMicHolder(arg0: bigint): Promise<Principal | null> {
        if (this.processError) {
            try {
                const result = await this.actor.getCurrentMicHolder(arg0);
    ...
    async getFollowerCount(arg0: Principal): Promise<FollowerCount> {
        if (this.processError) {
            try {
    ...
    async getGiftCatalog(): Promise<Array<GiftItem>> {
        if (this.processError) {
            try {
    ...
    async getGiftHistory(arg0: Principal): Promise<Array<GiftTransaction>> {
        if (this.processError) {
            try {
                const result = await this.actor.getGiftHistory(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getMicQueue(arg0: bigint): Promise<Array<MicRequest>> {
        if (this.processError) {
            try {
                const result = await this.actor.getMicQueue(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getRoom(arg0: bigint): Promise<Room | null> {
        if (this.processError) {
            try {
    ...
    async recordAudioClip(arg0: bigint, arg1: Uint8Array): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.recordAudioClip(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async requestMic(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.requestMic(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async sendGift(arg0: Principal, arg1: bigint): Promise<void> {
        if (this.processError) {
            try {
    ...
    async storeZegoCredentials(arg0: string, arg1: string): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.storeZegoCredentials(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
